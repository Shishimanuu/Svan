...
pinocchio_model_dir = join(dirname(dirname(str(abspath(__file__)))), "Code")
 
mesh_dir = pinocchio_model_dir
urdf_model_path = pinocchio_model_dir + '/ur_description/urdf/ur5_robot.urdf' if len(argv)<2 else argv[1]
